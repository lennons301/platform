...
for check in check-secrets check-versions check-environments check-documentation check-architecture check-ci-cd check-testing check-linting check-dev-environment check-local-development check-domain-modelling; do
